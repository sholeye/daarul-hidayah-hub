...
import { FiHome, FiUsers, FiCalendar, FiDollarSign, FiFileText, FiBell, FiSettings, FiLogOut, FiMenu, FiX } from 'react-icons/fi';
...
export const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-sidebar transform transition-transform duration-200 lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-sidebar-border">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-sidebar-foreground">Daarul Hidayah</h1>
          ...
          <div className="p-4 border-t border-sidebar-border">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-sidebar-accent flex items-center justify-center">
                <span className="text-sidebar-accent-foreground font-bold">{user?.name?.[0]}</span>
              </div>
      ...
      <div className="flex-1 lg:ml-64">
        {/* Header */}
        <header className="sticky top-0 z-40 h-16 bg-background/80 backdrop-blur-md border-b border-border flex items-center px-4 lg:px-6">
